      ...
      <div className=" mx-auto px-4 md:px-8 relative z-10">
        <div className="text-center mb-8 lg:mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#E46F49] mb-4">
            Why We <span className="text-[#4996e4] font-black">Exist</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col gap-4">
            {/* Mission Section */}
            <div className="bg-[#4996e4]/3 flex flex-col gap-2 p-8 rounded-2xl">
              <div className="flex items-center">
                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mr-4">
                  <Heart className="w-6 h-6 text-[#4996e4]" />
                </div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                To empower women and children through the promotion of
                comprehensive education and holistic development of individuals.
              </p>
            </div>
            ...
            <div className="bg-[#4996e4]/3 flex flex-col gap-2 p-8 rounded-2xl">
              <div className="flex items-center">
                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mr-4">
                  <Eye className="w-6 h-6 text-[#4996e4]" />
                </div>
